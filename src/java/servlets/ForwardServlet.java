...
public class ForwardServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            List<ForwardPlayers> fw = model.getPlayer(forwardId);
            List<Forward> forward = model.getAllForward();
            ...
            request.setAttribute("forwardplayers", fw);
            request.getRequestDispatcher("uzenet/forward.jsp").forward(request, response);
